-- Atualiza lógica de sincronização para concluir eventos baseados no status do pedido
...
DECLARE
    r RECORD;
BEGIN
    FOR r IN SELECT id FROM public.pedidos WHERE status IN ('Entregue', 'Finalizado', 'Cancelado') LOOP
